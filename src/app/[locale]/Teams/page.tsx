                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-2xl font-bold text-gray-900 dark:text-white">{team.tasks}</p>
                              <p className="text-xs text-gray-600 dark:text-gray-400">Tasks</p>
                            </div>
                            <div className="text-center">
                              <div className="flex items-center justify-center w-12 h-12 mx-auto mb-2 rounded-lg bg-green-50 dark:bg-green-900/20">
                                <Award className="w-6 h-6 text-green-600 dark:text-green-400" />
                              </div>
                              <p className="text-2xl font-bold text-gray-900 dark:text-white">{team.completionRate}%</p>
