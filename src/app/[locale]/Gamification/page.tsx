            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {[
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-2 ${selectedTab === tab.id
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["all", "common", "rare", "epic", "legendary"].map((rarity) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${selectedRarity === rarity
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredBadges.map((badge, index) => (
                    <motion.div
                      ...
                      whileHover="hover"
                      transition={{ delay: index * 0.1 }}
                      className={`bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border-2 ${getRarityBorder(badge.rarity)} ${badge.earned ? "opacity-100" : "opacity-60"
            ...
            {selectedTab === "leaderboard" && (
              <div className="space-y-4">
                {mockLeaderboard.map((user, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${user.position === 1 ? "bg-yellow-100 text-yellow-800" :
