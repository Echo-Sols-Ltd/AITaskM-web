          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                {/* Period Selector */}
                <div className="flex items-center gap-2 bg-white/80 backdrop-blur-lg rounded-xl p-1 border border-gray-200/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-gray-100/50"
              >
